...
(HACS-installable), that allows the user to mange the playback of music.
...
**vendored third-party integration** kept only for local testing. Never modify any of them. If any command — including
